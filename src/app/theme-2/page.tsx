                ...
                <div key={idx} className="space-y-4">
                  <div className="bg-gradient-to-br from-pink-100 to-white border-l-4 border-pink-400 p-4 rounded-xl shadow-lg text-pink-800 text-base font-semibold">
                    ...
                    <div className="mt-2 flex flex-wrap gap-2">
                      ...
                      {msg.recommendation && (
                        <div className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-pink-100 text-pink-800 ring-1 ring-inset ring-pink-200">
                          {msg.recommendation}
                        </div>
                      )}
                    </div>
