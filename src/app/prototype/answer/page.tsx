export default function Prototype() {
  const messages = [
    ...
    {
      sentence: 'They will be going to the zoo tomorrow.',
      tags: [
        { word: 'They', tag: 'PRP' },
        { word: 'will', tag: 'MD' },
        { word: 'be', tag: 'AUX' },
  ...
  return (
    <main className="w-screen h-screen bg-gradient-to-tr from-gray-100 to-neutral-200 flex flex-col justify-between py-8 px-4">
      <div className="w-full max-w-2xl mx-auto">
        <h1 className="z-10 bg-gradient-to-r from-black via-pink-500 to-violet-800 inline-block text-transparent bg-clip-text font-normal text-4xl leading-tight mb-4">
            ...
            <div key={idx} className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                {msg.tags.map(({ word, tag }, i) => (
                  <div
                    key={i}
                    className="group relative cursor-default px-3 py-2 rounded-xl border border-neutral-300 bg-neutral-50 shadow-sm hover:bg-neutral-100 transition"
                  >
